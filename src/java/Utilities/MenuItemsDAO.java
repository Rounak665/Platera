...
public List<MenuItems> getAllMenuItems() {
    ...
    try (Connection con = Database.getConnection();
        ...
        while (rs.next()) {
            ...
            String availability = rs.getString("availability");
            item.setAvailability("Y".equals(availability)); 
    ...
    public List<MenuItems> getMenuItemsByLocation(int location) {
        List<MenuItems> menuItems = new ArrayList<>();
        String query = "SELECT mi.item_id, mi.item_name, mi.price, mi.image, c.category_name, mi.availability, mi.restaurant_id,r.restaurant_name " +
                       "FROM menu_items mi " +
