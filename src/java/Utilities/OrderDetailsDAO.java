...
public class OrderDetailsDAO {
    ...
    public List<OrderDetails> getOrdersByLocation(int location_id) {
        ...
        try {
            ...
            String sql = "SELECT o.order_id, o.customer_id, u.name AS customer_name, "
                    ...
                    + "p.payment_method, p.payment_status, m.image AS item_image, o.order_status "
                    + "FROM orders o "
            ...
            while (rs.next()) {
                ...
                if (currentOrder == null || currentOrder.getOrderId() != orderId) {
                    ...
                    currentOrder.setOrderStatus(rs.getString("order_status")); // Set order status
                }
    ...
    public List<OrderDetails> getOrderDetailsByRestaurantId(int restaurantId) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ResultSet rs = null;
        List<OrderDetails> orderDetailsList = new ArrayList<>();
